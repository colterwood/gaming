...
def _make_tile(name):
    ...
    elif name == "hangar":          # M29: the Quinjet in its bay
        surf.fill(c("shadow"))
        pygame.draw.rect(surf, c("steel_dark"), r(0, 3, 16, 10))
        pygame.draw.rect(surf, c("steel"), r(0, 5, 16, 5))
        pygame.draw.line(surf, c("steel_light"), (0, 6), (15, 6))
        pygame.draw.rect(surf, c("sky"), r(3, 7, 3, 2))
        pygame.draw.rect(surf, c("red_dark"), r(11, 7, 3, 2))
    elif name == "treatment":       # M29: med bay chair + monitor
        surf.fill(c("steel_dark"))
        pygame.draw.rect(surf, c("white"), r(2, 6, 12, 8))
        pygame.draw.rect(surf, c("steel_light"), r(2, 6, 12, 8), 1)
        pygame.draw.rect(surf, c("mint"), r(4, 1, 8, 5))
        pygame.draw.line(surf, c("green"), (5, 3), (7, 3))
        pygame.draw.line(surf, c("green"), (8, 4), (10, 2))
        pygame.draw.rect(surf, c("red"), r(6, 9, 4, 2))
        pygame.draw.rect(surf, c("red"), r(7, 8, 2, 4))
    elif name == "workbench":       # M29: tech lab fabricator
        surf.fill(c("steel_dark"))
        pygame.draw.rect(surf, c("steel"), r(0, 6, 16, 9))
        pygame.draw.rect(surf, c("navy"), r(1, 1, 14, 5))
        pygame.draw.rect(surf, c("gold"), r(3, 2, 4, 3))
        pygame.draw.rect(surf, c("sky"), r(9, 2, 4, 3))
        pygame.draw.line(surf, c("steel_light"), (0, 7), (15, 7))
        surf.set_at((4, 11), c("orange"))
        surf.set_at((12, 11), c("orange"))
    elif name == "pym bench":       # M29: shrink/grow bench
        surf.fill(c("steel_dark"))
        pygame.draw.rect(surf, c("purple"), r(0, 5, 16, 10))
        pygame.draw.rect(surf, c("steel_light"), r(0, 5, 16, 2))
        pygame.draw.circle(surf, c("red"), (5, 10), 3)
        pygame.draw.circle(surf, c("mint"), (11, 10), 1)
        surf.set_at((8, 3), c("mint"))
        surf.set_at((13, 2), c("red"))
    elif name == "rack":
        surf.fill(c("steel_dark"))
        pygame.draw.rect(surf, c("steel"), r(1, 1, 14, 14), 1)
